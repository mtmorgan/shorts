...
<p>
	...
	<a href="https://merlin.allaboutbirds.org/">Merlin</a> app, listening to the birds
	for a half hour or so. We'd note the birds in a Google sheet.
</p>
...
<p>
	<a href="https://merlin.allaboutbirds.org/">Merlin</a> really engaged us with the
	birds at our place. We'd get to the Pond cabin some time between 9 and noon. We
	didn't record the weather or other factors. We relied on Merlin for bird identification,
...
<p>
	This page uses <a href="https://svelte.dev/docs/kit/introduction">SvelteKit</a
	>
	and <a href="https://sveltestrap.js.org/">Sveltestrap</a> for front-end
	styling. The 'punchcard' and other plots use
	<a href="https://d3js.org/">D3</a>. A JavaScript pre-processing step accesses
	the Google sheet to transform the observational data to a JSON file.
</p>
<p>
